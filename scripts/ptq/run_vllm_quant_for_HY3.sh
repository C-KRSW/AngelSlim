...
#     into ${act_dir}.
#
# Stage 2: tools/fp8_quant_with_vllm_activation_622p3.py
...
# ----------------------------------------------------------------------------
# vLLM / Ray runtime knobs (mirrors run_vllm_calibrate_for_HY3_0_622post3.sh)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
run_name=hy3.0_vllm_calib-codeagent-32k-e92-s60
...
act_dir=/dockerdata/e92-s60-fp8-vllm_act-2
fp8_path=/dockerdata/e92-s60-fp8-2
...
if [[ "${do_quantize}" -eq 1 ]]; then
    ...
    python3 tools/fp8_quant_with_vllm_activation_622p3.py \
