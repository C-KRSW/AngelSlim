...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Directory to save output statistics"
    )
    ...
    parser.add_argument(
        "--max-length", type=int, default=16384,
...
def _run_pertensor(args, llm, prompts):
    ...
    save_json(
        activation_stats, args.output_dir, "activation_stats.json",
    ...
    print(f"  Multiplier range: [{args.search_kv_min_multiplier}, {args.search_kv_max_multiplier}]")
    ...
    save_json(kv_multipliers, args.output_dir, "kv_scale_multipliers.json",
    ...
    save_json(tuned_kv_scales, args.output_dir, "kv_cache_tuned_scales.json",
...
def _run_perhead(args, llm, prompts):
    ...
    save_json(
        activation_stats_perhead, args.output_dir, "activation_stats_per_head.json",
    ...
    save_json(kv_multipliers_perhead, args.output_dir, "kv_scale_multipliers_per_head.json",
    ...
    save_json(tuned_kv_scales_perhead, args.output_dir, "kv_cache_tuned_scales_per_head.json",
